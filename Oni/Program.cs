...
namespace Oni
{
	internal class Program
	{
		...
		private static int Help(string[] args)
		{
			...
			Console.WriteLine("\t-create:trbs <directory> [-blender] dae_file");
			Console.WriteLine("\t-create:subt <directory> txt_file");
			Console.WriteLine("\t-create <directory> [-blender] [-dense|-keepkeys] [-tolerance:degrees] xml_file\tCreates an .oni file from an XML file");
			Console.WriteLine();
